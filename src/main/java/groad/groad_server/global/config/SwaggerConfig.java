...
public class SwaggerConfig {
    ...
    private static final String apiTitle = "Groad API";

    private static final String apiDescription = "Groad API Test 페이지";
    ...
    public Docket api() {
        return new Docket(DocumentationType.OAS_30)
                ...
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("groad.groad_server")) // Controller가 들어있는 패키지. 이 경로의 하위에 있는 api만 표시됨.
